...
namespace WF.Sample.Business
{
    ...
    partial void DeleteLoadTestingOperation(LoadTestingOperation instance);
        ...
        base(System.Configuration.ConfigurationManager.ConnectionStrings["SqlConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnIsHeadChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Employee_EmployeeRole", Storage="_EmployeeRoles", ThisKey="Id", OtherKey="EmloyeeId")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Employee_Document", Storage="_Documents", ThisKey="Id", OtherKey="EmloyeeControlerId")]
	...
	public partial class EmployeeRole : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Guid _EmloyeeId;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnEmloyeeIdChanging(System.Guid value);
    ...
    partial void OnRoleIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_EmloyeeId", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
		public System.Guid EmloyeeId
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Employee_EmployeeRole", Storage="_Employee", ThisKey="EmloyeeId", OtherKey="Id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
			...
			set
			{
							...
							|| (this._Employee.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._EmloyeeId = value.Id;
					}
					else
					{
						this._EmloyeeId = default(System.Guid);
					}
	...
	public partial class Document : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<System.Guid> _EmloyeeControlerId;
    ...
    partial void OnEmloyeeControlerIdChanging(System.Nullable<System.Guid> value);
    partial void OnEmloyeeControlerIdChanged();
    ...
    partial void OnStateNameChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_EmloyeeControlerId", DbType="UniqueIdentifier")]
		public System.Nullable<System.Guid> EmloyeeControlerId
		{
			get
			{
				return this._EmloyeeControlerId;
			}
			set
			{
				if ((this._EmloyeeControlerId != value))
				{
					if (this._Employee.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnEmloyeeControlerIdChanging(value);
					this.SendPropertyChanging();
					this._EmloyeeControlerId = value;
					this.SendPropertyChanged("EmloyeeControlerId");
					this.OnEmloyeeControlerIdChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Employee_Document", Storage="_Employee", ThisKey="EmloyeeControlerId", OtherKey="Id", IsForeignKey=true)]
		public Employee Employee
		{
			get
			{
			...
			set
			{
							...
							|| (this._Employee.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._EmloyeeControlerId = value.Id;
					}
					else
					{
						this._EmloyeeControlerId = default(Nullable<System.Guid>);
					}
					this.SendPropertyChanged("Employee");
				}
			}
